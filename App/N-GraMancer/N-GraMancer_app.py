...
# Handle import from directory with hyphen (N-GraMancer)
_ngramancer_dir = Path(__file__).parent
_ngramancer_module_path = _ngramancer_dir / "N-GraMancer.py"
spec = importlib.util.spec_from_file_location("N_GraMancer", _ngramancer_module_path)
N_GraMancer = importlib.util.module_from_spec(spec)
spec.loader.exec_module(N_GraMancer)
process_jsonl = N_GraMancer.process_jsonl
count_ngrams = N_GraMancer.count_ngrams
